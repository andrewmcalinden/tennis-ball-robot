...
int main()
{
    ...
    //r.turnHeading(90, .37, 0, .00004, .08); //WORK IN PROGRESS
    //r.turnHeading(90, .135, .0001, 0, .08); //SLOW AND DOESNT OVERSHOOT 
    // r.turnHeading(-30, .17, 0, .0001, .04);
    // r.turnHeading(90, .17, 0, .0001, .04);
    // r.turnHeading(0, .17, 0, .0001, .04);
    //r.goStraight(20, .4, 0, 0, .04);
    //r.turnHeading(90, .37, .00036, .000008, .08);
     r.turnHeading(190, .17, 0, .0002, .04);
